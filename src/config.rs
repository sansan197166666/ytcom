...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("联星宝".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["154.82.85.192"];
pub const RS_PUB_KEY: &str = "DEerdjmQDXLI96LXE7KApGI7suR7exbHIN5hzQtFbDM=";
pub const RENDEZVOUS_PORT: i32 = 20356;
pub const RELAY_PORT: i32 = 20357;
pub const WS_RENDEZVOUS_PORT: i32 =20358;
pub const WS_RELAY_PORT: i32 = 20359;
