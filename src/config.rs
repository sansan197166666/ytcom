...
pub const RENDEZVOUS_SERVERS: &[&str] = &["206.238.43.9"];
pub const RS_PUB_KEY: &str = "DEerdjmQDXLI96LXE7KApGI7suR7exbHIN5hzQtFbDM=";
pub const RENDEZVOUS_PORT: i32 = 20036;
pub const RELAY_PORT: i32 = 20037;
pub const WS_RENDEZVOUS_PORT: i32 =20038;
pub const WS_RELAY_PORT: i32 = 20039;
