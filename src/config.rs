...
pub const RENDEZVOUS_SERVERS: &[&str] = &["154.82.84.121"];
pub const RS_PUB_KEY: &str = "DEerdjmQDXLI96LXE7KApGI7suR7exbHIN5hzQtFbDM=";
pub const RENDEZVOUS_PORT: i32 = 19916;
pub const RELAY_PORT: i32 = 19917;
pub const WS_RENDEZVOUS_PORT: i32 =19918;
pub const WS_RELAY_PORT: i32 = 19919;
