...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("联星V".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["154.91.90.214"];
pub const RS_PUB_KEY: &str = "DEerdjmQDXLI96LXE7KApGI7suR7exbHIN5hzQtFbDM=";
pub const RENDEZVOUS_PORT: i32 = 20046;
pub const RELAY_PORT: i32 = 20047;
pub const WS_RENDEZVOUS_PORT: i32 =20048;
pub const WS_RELAY_PORT: i32 = 20049;
