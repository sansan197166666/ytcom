...
pub const RENDEZVOUS_SERVERS: &[&str] = &["154.91.90.146"];
pub const RS_PUB_KEY: &str = "DEerdjmQDXLI96LXE7KApGI7suR7exbHIN5hzQtFbDM=";
pub const RENDEZVOUS_PORT: i32 = 19906;
pub const RELAY_PORT: i32 = 19907;
pub const WS_RENDEZVOUS_PORT: i32 =19908;
pub const WS_RELAY_PORT: i32 = 19909;
