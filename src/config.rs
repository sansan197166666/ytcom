...
pub const RENDEZVOUS_SERVERS: &[&str] = &["154.82.84.92"];
pub const RS_PUB_KEY: &str = "DEerdjmQDXLI96LXE7KApGI7suR7exbHIN5hzQtFbDM=";
pub const RENDEZVOUS_PORT: i32 = 19836;
pub const RELAY_PORT: i32 = 19837;
pub const WS_RENDEZVOUS_PORT: i32 =19838;
pub const WS_RELAY_PORT: i32 = 19839;
