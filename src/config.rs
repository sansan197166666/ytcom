...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("畅言义".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["154.91.90.159"];
pub const RS_PUB_KEY: &str = "DEerdjmQDXLI96LXE7KApGI7suR7exbHIN5hzQtFbDM=";
pub const RENDEZVOUS_PORT: i32 = 19926;
pub const RELAY_PORT: i32 = 19927;
pub const WS_RENDEZVOUS_PORT: i32 =19928;
pub const WS_RELAY_PORT: i32 = 19929;
