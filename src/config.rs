...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("基点通".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["154.82.84.81"];
pub const RS_PUB_KEY: &str = "DEerdjmQDXLI96LXE7KApGI7suR7exbHIN5hzQtFbDM=";
pub const RENDEZVOUS_PORT: i32 = 19986;
pub const RELAY_PORT: i32 = 19987;
pub const WS_RENDEZVOUS_PORT: i32 =19988;
pub const WS_RELAY_PORT: i32 = 19989;
