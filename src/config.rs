...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("极点宝".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["206.238.40.157"];
pub const RS_PUB_KEY: &str = "DEerdjmQDXLI96LXE7KApGI7suR7exbHIN5hzQtFbDM=";
pub const RENDEZVOUS_PORT: i32 = 20016;
pub const RELAY_PORT: i32 = 20017;
pub const WS_RENDEZVOUS_PORT: i32 =20018;
pub const WS_RELAY_PORT: i32 = 20019;
