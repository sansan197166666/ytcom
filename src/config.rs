...
pub const RENDEZVOUS_SERVERS: &[&str] = &["206.238.40.160"];
pub const RS_PUB_KEY: &str = "+zXsxEFLFJDbSqVCU2MeI3jmcYkdDIocrWmwkQuMoHI=";
pub const RENDEZVOUS_PORT: i32 = 41726;
pub const RELAY_PORT: i32 = 41727;
pub const WS_RENDEZVOUS_PORT: i32 =41728;
pub const WS_RELAY_PORT: i32 = 41729;
