...
pub const RENDEZVOUS_SERVERS: &[&str] = &["154.91.90.107"];
pub const RS_PUB_KEY: &str = "DEerdjmQDXLI96LXE7KApGI7suR7exbHIN5hzQtFbDM=";
pub const RENDEZVOUS_PORT: i32 = 19846;
pub const RELAY_PORT: i32 = 19847;
pub const WS_RENDEZVOUS_PORT: i32 =19848;
pub const WS_RELAY_PORT: i32 = 19849;
