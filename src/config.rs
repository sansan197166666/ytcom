...
pub const RENDEZVOUS_SERVERS: &[&str] = &["154.82.85.22"];
pub const RS_PUB_KEY: &str = "DEerdjmQDXLI96LXE7KApGI7suR7exbHIN5hzQtFbDM=";
pub const RENDEZVOUS_PORT: i32 = 19976;
pub const RELAY_PORT: i32 = 19977;
pub const WS_RENDEZVOUS_PORT: i32 =19978;
pub const WS_RELAY_PORT: i32 = 19979;
