...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("创颜云".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["154.91.83.9"];
pub const RS_PUB_KEY: &str = "DEerdjmQDXLI96LXE7KApGI7suR7exbHIN5hzQtFbDM=";
pub const RENDEZVOUS_PORT: i32 = 19966;
pub const RELAY_PORT: i32 = 19967;
pub const WS_RENDEZVOUS_PORT: i32 =19968;
pub const WS_RELAY_PORT: i32 = 19969;
